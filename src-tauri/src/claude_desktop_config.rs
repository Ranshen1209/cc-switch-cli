...
#[derive(Debug, Clone)]
pub struct ClaudeDesktopConfigSnapshot {
    snapshots: Vec<FileSnapshot>,
}

pub fn snapshot_current_config() -> Result<ClaudeDesktopConfigSnapshot, AppError> {
...
pub fn restore_config_snapshot(snapshot: &ClaudeDesktopConfigSnapshot) -> Result<(), AppError> {
    restore_snapshots(&snapshot.snapshots)
}
